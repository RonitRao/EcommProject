  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h2 style={{ margin: '0 0 6px 0', fontSize: '24px', fontWeight: '700', color: '#fff' }}>Sign Up</h2>
        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px', margin: '0 0 28px 0' }}>Create your AURA account</p>
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          <label style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '11px', color: 'rgba(255,255,255,0.4)', letterSpacing: '1px' }}>
            EMAIL ADDRESS
            <input name="email" type="email" value={form.email} onChange={handle} required style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', padding: '12px', borderRadius: '8px', color: '#fff', fontSize: '14px', outline: 'none' }} />
          </label>
        ...
        <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginTop: '28px', textAlign: 'center', marginBlockEnd: 0 }}>
          Already have an account? <Link to="/login" style={{ color: '#ffffff', fontWeight: '600', textDecoration: 'underline' }}>Sign In</Link>
        </p>
      </div>
    </div>
  );
